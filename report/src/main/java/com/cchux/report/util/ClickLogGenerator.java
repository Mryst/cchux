package com.cchux.report.util;
        ...
        import com.cchux.report.bean.ClickLog;
...
public class ClickLogGenerator {
    ...
    private static String[] provinces = new String[]{"HeNan","Beijing"};//地区-省集合
    private static String[] citys = new String[]{"ShiJiaZhuang","ZhengZhou", "RuZhou"};//地区-市集合
     ...
     * 浏览器
     */
    private static String[] brower = new String[]{"火狐","qq浏览器","360浏览器","chrome浏览器"};
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        while(true){
            ...
            //在频道集合中，随机生成一个0-频道集合长度的下标，获取对应的频道id
            ...
            Thread.sleep(1000);
            send("http://localhost:8888/receive", jsonstr);
        }
    }
}
